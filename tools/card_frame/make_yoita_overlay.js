// 与板フレーム overlay 生成（寺泊 make_teradomari_overlay.js と同一方式）。
// 窓（中央の空クリーム）を透過し、下部シルエット帯は上端フェード→下端不透過の半透明ブレンド。
// 実測: 窓 left=208 / right=953 / top≈76、下部シーン上端≈1300-1390。
const sharp = require("sharp");
const RAW = "C:/Users/masat/Desktop/nagaoka-walk/tools/card_frame/frame_yoita_raw.png";
const OUT_OVL = "C:/Users/masat/Desktop/nagaoka-walk/tools/card_frame/frame_yoita_overlay.png";
const GCREAM = 226;
const WIN_YMAX = 1300;      // flood-fill the empty window down to here (just above the scenery footer)
const FOOT_X0 = 208, FOOT_X1 = 951;   // silhouette interior x-range (inside side borders)
const GRAD_TOP = 1290, GRAD_FULL = 1470; // alpha ramps 0 (top, blends w/ art) -> MAXA (solid)
