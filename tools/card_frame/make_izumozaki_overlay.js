// 出雲崎フレーム overlay 生成（クリーンなくり抜き方式・三島と同一方針）。
...
const RAW = "C:/Users/masat/Desktop/nagaoka-walk/tools/card_frame/frame_izumozaki_raw.png";
const OUT_OVL = "C:/Users/masat/Desktop/nagaoka-walk/tools/card_frame/frame_izumozaki_overlay.png";
...
(async()=>{
  ...
  console.log("izumozaki overlay (crisp knockout) written. transparent px="+t0+".");
