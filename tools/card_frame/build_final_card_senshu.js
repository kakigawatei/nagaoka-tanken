// 千秋エリア用カード生成器（枠なしアート＋千秋フレーム＋自動フィット縦ロゴ型押し）
// 蔵王/寺泊/山古志/栃尾/越路/三島版と同一構造。フレームだけ frame_senshu_overlay.png に差し替え。
// 窓は x215-954（左ロゴ帯幅は他エリアとほぼ一致）、下部シルエット(丘陵＋花畑＋竪穴住居)はくっきり。
// usage: node build_final_card_senshu.js "<artFileUrl>" "KOME HYAPPYO" "<outHtml>" [offsetY]
...
const FRAME = 'file:///C:/Users/masat/Desktop/nagaoka-walk/tools/card_frame/frame_senshu_overlay.png';
