// 与板エリア用カード生成器（枠なしアート＋与板フレーム＋自動フィット縦ロゴ型押し）
// 寺泊/山古志版と同一構造。フレームだけ frame_yoita_overlay.png に差し替え。
// 窓は x208-953（左端は山古志/摂田屋/寺泊と同じ＝ロゴ帯幅一致）、下部シルエット(信濃川+城下町+城山)は上端フェード。
// usage: node build_final_card_yoita.js "<artFileUrl>" "TSUNO JINJA" "<outHtml>" [offsetY]
...
const FRAME = 'file:///C:/Users/masat/Desktop/nagaoka-walk/tools/card_frame/frame_yoita_overlay.png';
