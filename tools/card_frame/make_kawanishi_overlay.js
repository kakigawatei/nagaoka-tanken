// 川西フレーム overlay 生成（クリーンなくり抜き方式・三島と同一方針）。
...
const RAW = "C:/Users/masat/Desktop/nagaoka-walk/tools/card_frame/frame_kawanishi_raw.png";
const OUT_OVL = "C:/Users/masat/Desktop/nagaoka-walk/tools/card_frame/frame_kawanishi_overlay.png";
...
(async()=>{
  ...
  console.log("kawanishi overlay (crisp knockout) written. transparent px="+t0+".");
