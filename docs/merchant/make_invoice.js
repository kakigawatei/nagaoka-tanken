 ...
 *
 *   ⚠️【2026-07-24 マネタイズ方針＝通常3プラン＋期間限定キャンペーン割引】
 *   通常：ライト¥3,000/スタンダード¥6,000/プレミアム¥12,000月額＋加盟金¥5,000。
 *   2026/12/31までのキャンペーン＝ライト無料／スタンダード¥3,000／プレミアム¥6,000／加盟金無料。
 *   →振込請求はキャンペーン価格で（ライトは無料=請求不要）。--plan固定価格や先行割引・一括前払いは旧版。金額は都度指定推奨。
 *
